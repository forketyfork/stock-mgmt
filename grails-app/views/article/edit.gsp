...
<div class="container">
    ...
    <div class="row">
        <g:form action="save" class="form-horizontal col-md-6">
            <div class="form-group">
                <label for="externalId" class="col-sm-4 control-label"><g:message
            ...
            <div class="form-group">
                <label for="name" class="col-sm-4 control-label"><g:message code="article.form.field.name"/></label>
            ...
            <div class="form-group">
                <label for="brand" class="col-sm-4 control-label"><g:message code="article.form.field.brand"/></label>
            ...
            <div class="form-group">
                <label for="price" class="col-sm-4 control-label"><g:message code="article.form.field.price"/></label>
            ...
            <div class="form-group">
                <label for="volume" class="col-sm-4 control-label"><g:message code="article.form.field.volume"/></label>
            ...
            <div class="form-group">
                <label for="amount" class="col-sm-4 control-label"><g:message code="article.form.field.amount"/></label>
